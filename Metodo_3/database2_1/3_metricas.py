...
for s in SEEDS:
    ...
    data_path = f'./Metodo_3/database2_1/data/seed_{s}'
    model_path = f'./Metodo_3/database2_1/models/seed_{s}/metodo3_svm.pkl'
    results_dir = f'./Metodo_3/database2_1/results/seed_{s}'
    os.makedirs(results_dir, exist_ok=True)
    
    X_test = np.load(f'{data_path}/X_test_db1.npy')
    y_test = np.load(f'{data_path}/y_test_db1.npy')
